-- Achado da varredura pos-correcao critica (2026-07-07): create_order_secure
-- nao validava que a mesa (p_table_id) pertence a loja do pedido (p_store_id)
-- -- um chamador podia mandar mesa da Loja A + store_id da Loja B, gerando
-- pedido com table_id/store_id inconsistentes.
