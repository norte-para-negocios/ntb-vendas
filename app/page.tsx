...
export default function HomePage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden p-6 text-center" style={{ background: BG }}>
      ...
      <div ref={cloudBackRef} className="absolute bottom-0 pointer-events-none transition-transform duration-75 ease-linear will-change-transform" style={{ opacity: 0.5, left: '-6%', width: '112%', height: 'clamp(130px, 22vh, 260px)' }}>
        <svg className="w-full h-full block" viewBox="0 0 1440 349" fill="none" preserveAspectRatio="none">
      ...
      <div ref={cloudFrontRef} className="absolute bottom-0 pointer-events-none transition-transform duration-75 ease-linear will-change-transform" style={{ left: '-4%', width: '108%', height: 'clamp(110px, 18vh, 220px)' }}>
        <svg className="w-full h-full block" viewBox="0 0 1440 295" fill="none" preserveAspectRatio="none">
