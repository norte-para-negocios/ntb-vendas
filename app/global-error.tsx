  ...
  return (
    <html lang="pt-BR">
      <body style={{ fontFamily: 'system-ui, sans-serif', padding: 24, textAlign: 'center' }}>
        ...
        {/* Correção (revisão independente, fix round 1): mesmo motivo do
            app/error.tsx — "seus dados continuam salvos" é falso enquanto o
            pedido ainda está só no carrinho em memória, sem ter sido
            enviado. */}
        <p style={{ fontSize: 14, color: '#666' }}>Pedidos já enviados continuam salvos. Se estava montando um pedido, confira antes de enviar de novo.</p>
